...
const finalPrice = calculateTotalPrice(calculatePrice, calculateToppingsPrice);

function placeOrder(){

  let Size = document.getElementById("crust").value;

  let Lenght = document.querySelector("input[name='pizzaSize']:checked").value;


  let checkedItems = document.querySelectorAll("input[name='topping']:checked");
